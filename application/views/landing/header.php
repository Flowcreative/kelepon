     ...
     <div class="main_menu" id="mainNav">
         <nav class="navbar navbar-expand-lg navbar-light">
             <div class="container box_1620">
                 ...
                 <a class="navbar-brand logo_h ml-4" href="<?= base_url() ?>"><img src="<?= base_url('src/landing/') ?>img/logo1.png" alt="" style="width: 600; height: 100px;"></a>
                     ...
                     <ul class="nav navbar-nav menu_nav ml-auto">
                         ...
                         <li class="nav-item submenu dropdown">
                             ...
                             <ul class="dropdown-menu">
                                 ...
                                 <li class="nav-item"><a class="nav-link" href="https://drive.google.com/file/d/1_AkLJ_0a-USaCAjSOUlEe_SO6LeYufiR/view?usp=sharing" target="_blank">Siaga (SD)</a></li>
                                 <li class="nav-item"><a class="nav-link" href="https://drive.google.com/file/d/1_APHU47DR1S9kzmt677TYx_knaWo7TCY/view?usp=sharing" target="_blank">Penggalang (SMP)</a></li>
                                 <li class="nav-item"><a class="nav-link" href="https://drive.google.com/file/d/1_62iYa4CFxww2h9HzSgajhVylxZb050i/view?usp=sharing" target="_blank">Penegak (SMA)</a></li>
                                 <li class="nav-item"><a class="nav-link" href="https://drive.google.com/file/d/1_54XuwumXdtr5vZ5cMrPbhvsoI86OsAx/view?usp=sharing" target="_blank">Pandega (Mahasiswa)</a></li>
                             </ul>
                         </li>
