            ...
            <div class="col-xl-5 col-lg-6 col-md-8 col-sm-11 mt-4">
                <div class="card text-center h-100">
                    <div class="card-body px-5 pt-5 d-flex flex-column">
                        <div>
                            <div class="h3 text-teal">Pembayaran Berhasil 🥰</div>
                            <p class="text-muted mb-4">Sekarang kakak sudah bisa lengkapi data lomba</p>
                        </div>
                    ...
                    <!-- </div> -->
                    <a class="btn btn-block btn-teal btn-sm" href="<?= base_url('peserta/matalombadipilih') ?>">Lengkapi Data</a>
